...
const AUFGABEN_FIELDS = [
  { key: 'aufgabe_titel', label: 'Titel', type: 'string/text' },
  { key: 'aufgabe_beschreibung', label: 'Beschreibung', type: 'string/textarea' },
  { key: 'aufgabe_faelligkeit', label: 'Fälligkeitsdatum', type: 'date/date' },
  { key: 'aufgabe_prioritaet', label: 'Priorität', type: 'lookup/select', options: [{ key: 'niedrig', label: 'Niedrig' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }, { key: 'sehr_hoch', label: 'Sehr hoch' }] },
  { key: 'aufgabe_kategorie', label: 'Kategorie', type: 'applookup/select', targetEntity: 'kategorien', targetAppId: 'KATEGORIEN', displayField: 'kategorie_name' },
  { key: 'aufgabe_erledigt', label: 'Erledigt', type: 'bool' },
];
const KATEGORIEN_FIELDS = [
  ...
  { key: 'kategorie_farbe', label: 'Farbe', type: 'lookup/select', options: [{ key: 'rot', label: 'Rot' }, { key: 'blau', label: 'Blau' }, { key: 'gruen', label: 'Grün' }, { key: 'orange', label: 'Orange' }, { key: 'lila', label: 'Lila' }, { key: 'grau', label: 'Grau' }, { key: 'gelb', label: 'Gelb' }] },
];
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<EntityKey>('aufgaben');
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'aufgaben' && fieldKey === 'aufgabe_kategorie') {
