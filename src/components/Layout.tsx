...
import { IconArrowBackUp, IconLayoutDashboard, IconMenu2, IconSettings, IconSquareCheck, IconTag } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';
import ActionsBar from '@/components/ActionsBar';

const APP_TITLE = 'Aufgabenverwaltung';
...
const navigation = [
  ...
  { name: 'Aufgaben', href: '/aufgaben', icon: IconSquareCheck },
  { name: 'Kategorien', href: '/kategorien', icon: IconTag },
];

const externalNavigation = [
  { name: 'Aufgaben', href: '/gateway/apps/6997691f9dfd8dc4cf1a38f4?template=list_page', icon: IconSquareCheck },
  { name: 'Kategorien', href: '/gateway/apps/6997691c70d60eee9c1ba546?template=list_page', icon: IconTag },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/6997691f9dfd8dc4cf1a38f4?template=list_page"
